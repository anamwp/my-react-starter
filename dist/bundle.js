...
(0, _Notification.notify)('Hello another notify'); // import notify from './Notification';

(0, _Notification.log)('I am log message');

_Notification2.default.author('Rework - martin');
_Notification2.default.publisher('Jason fried');
